...
$API_KEY = 'LYh8aLnK3aKVWOQycd5DzPTTrzZg1JY_DYYxs_2YPhIKd9ZpJfE8qR0TRS6nTfzUbGp5Rc5PgnwuBotVWQsyH1BNTr-m4KQxpgEqPPnBgQoV1tT17HTU1Rvu2zWQXHYx';
// if(empty($API_KEY)){
...
function query_api($term, $location) {   
    ...
    //     $businessDetails = get_business($business_id);
    //     $allBusinessDetails[] = $businessDetails;
    // }
    
    print(json_encode($response));
    // print(json_encode($allBusinessDetails));
...
//    print sprintf("Result for business \"%s\" found:\n", $business_id);
    ...
    // Code commented above does a search in Yelp's API
    // Then gets the business id of the first one returned
    // Then specifically gets the business details of 
